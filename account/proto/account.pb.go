...
func (x *CreateUserReply) GetOk() string {
	if x != nil {
		return x.Ok
	}
	return ""
...
var file_account_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x45, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x69, 0x64, 0x22, 0x50, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70,
	...
	0x77, 0x6f, 0x72, 0x64, 0x32, 0x80, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x12, 0x35, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x70, 0x72,
	...
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f,
...
var file_account_proto_goTypes = []interface{}{
	...
	(*CreateUserReply)(nil),   // 1: proto.CreateUserReply
	(*GetUserRequest)(nil),    // 2: proto.GetUserRequest
	(*GetUserReply)(nil),      // 3: proto.GetUserReply
}
var file_account_proto_depIdxs = []int32{
	0, // 0: proto.Account.CreateUser:input_type -> proto.CreateUserRequest
	2, // 1: proto.Account.GetUser:input_type -> proto.GetUserRequest
	1, // 2: proto.Account.CreateUser:output_type -> proto.CreateUserReply
	3, // 3: proto.Account.GetUser:output_type -> proto.GetUserReply
...
func (c *accountClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserReply, error) {
...
func (*UnimplementedAccountServer) CreateUser(context.Context, *CreateUserRequest) (*CreateUserReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (*UnimplementedAccountServer) GetUser(context.Context, *GetUserRequest) (*GetUserReply, error) {
